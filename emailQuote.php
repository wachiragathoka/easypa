...
$quotation=$pdf->Output('S','Personal Accident Quote.pdf');
...
$mail->SMTPSecure = "tls";
$mail->SMTPDebug  = 3; 
$mail->Username = "MGathoka@uap-group.com";
$mail->Password = "javadama50)_+";

$mail->setFrom('MGathoka@uap-group.com', 'Matthew Gathoka');
$mail->addAddress('wachiragathoka@gmail.com', 'Wachira Gathoka');
$mail->AddReplyTo('MGathoka@uap-group.com', 'Matthew Gathoka');
$mail->Subject = 'Personal Accident Cover Quotation';
$mail->isHTML(true);
$mail->AddAttachment($quotation);
