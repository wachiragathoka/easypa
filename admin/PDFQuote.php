...
$customerData=$datasource->getCustomerdata($policy_id);
...
$coverdetails=$datasource2->getPolicyDetails($policy_id);
...
$selectedCoverbenefits=$datasource3->getSelectedCoverBenefits($policy_id);
...
$declarationQuestions= $declarationQuestionsDatasource->getdeclarationQuestions($policy_id); 

$declarationsResponsesDatasource=new Model();
$declarationsResponses=$declarationsResponsesDatasource->getDeclarationsResponses($policy_id); 
